#!/usr/bin/env python2
#github guide :::::: https://github.com/WebGoat/WebGoat

#docker image docker run -it -p 127.0.0.1:80:8888 -p 127.0.0.1:8081:8080 -p 127.0.0.1:9090:9090 -e TZ=Europe/Amsterdam webgoat/goatandwolf:v8.2.1

# The landing page will be located at: http://localhost
# WebGoat will be located at: http://localhost:8080/WebGoat/login/
...
apiKey='a2li71ihu873onr3mob525gnqc'
...
globalExcludeUrl = ['^(?:(?!http:\/\/localhost:8090).*).$']
...
# Asolute local path
proxyScriptFileName = 'proxyScript.js'
...
contextIncludeURL = ['http://localhost:8090/bodgeit.*']
# Define Context Exclude URL regular expressions. Ignored if useContextForScan
# is False. List can be empty.
contextExcludeURL = ['http://localhost:8090/bodgeit/logout.jsp']
...
# Absolute local path
authScriptFileName = 'TwoStepAuthntication.js'
...
#               'Target URL=http://localhost:8090/bodgeit')
## Here is an example for formBasedAuthentication method:
authParams = ('loginUrl=http://localhost:8090/bodgeit/login.jsp'
...
indicatorRegex = '\QLocation:\Q<a href="logout.jsp">Logout</a>\E'
...
userList = [
    {'name': 'test user', 'credentials': 'Username=test@gmail.com&Password=weakPassword'},
...
target = 'http://localhost:8090/bodgeit'
